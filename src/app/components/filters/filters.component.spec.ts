...
import { CommonModule } from '@angular/common'; // If needed for common directives or pipes
import { FiltersComponent } from './filters.component'; // Import your standalone component
...
describe('FiltersComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [CommonModule, FiltersComponent], // Add FiltersComponent to imports, not declarations
      providers: [
